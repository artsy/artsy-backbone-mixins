...
describe('Dimensions Mixin', function() {
  ...
  describe('#dimensions', function() {
    ...
    it('can still function with missing dimensions data', function() {
      model.set({ metric: 'in', dimensions: null });
      model.dimensions();
    });

    it('returns the dimensions chosen by metric', function() {
    ...
    it('wraps the dimensions string in a superscript tag when it encounters ' +
       'fractions following whole numbers', function() {
    ...
    it('leaves bare fractions alone', function() {
    ...
    it('converts fraction strings to decimals', function() {
